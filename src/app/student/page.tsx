...
import { GraduationCap, CalendarCheck, Award, BookOpen, Receipt, Sparkles, Clock, CheckCircle2, ArrowRight } from 'lucide-react';
...
export default function StudentDashboardPage() {
  ...
  return (
    <PortalLayout allowedRoles={['Student', 'SuperAdmin']}>
      {/* Student Welcome Banner with Photo */}
      <div className="bg-gradient-to-r from-blue-950 via-slate-900 to-indigo-950 rounded-3xl p-6 sm:p-8 text-white shadow-xl flex flex-col md:flex-row items-center justify-between gap-6 border border-blue-800/40">
        <div className="flex items-center gap-5">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-300">
              Admission No: <strong className="text-amber-300 font-mono">SGM-2026-0001</strong> • Class: <strong>Class 10 (Section A)</strong> • Roll No: <strong>01</strong>
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <Link href="/student/results">
            <Button size="sm" variant="primary" className="bg-blue-600 hover:bg-blue-700 font-bold" leftIcon={<Award className="w-4 h-4" />}>
              Unit Test Marksheet
            </Button>
          </Link>
        ...
        <div className="lg:col-span-8">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Badge variant="info" size="sm">6 Periods</Badge>
            </CardHeader>
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="p-6 bg-gradient-to-br from-blue-900 to-indigo-900 text-white rounded-3xl space-y-4 shadow-md">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-200">Grade: <strong className="text-emerald-300">A1 (Outstanding)</strong> | Class Rank: <strong className="text-white">#1</strong></p>
            </div>
