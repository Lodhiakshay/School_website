...
export default function StudentAttendancePage() {
  ...
  const augustDays = [
    { day: '01 Aug', status: 'Present', punch: '08:45 AM' },
    { day: '02 Aug', status: 'Present', punch: '08:42 AM' },
    { day: '03 Aug', status: 'Sunday', punch: '—' },
    { day: '04 Aug', status: 'Present', punch: '08:48 AM' },
    { day: '05 Aug', status: 'Present', punch: '08:50 AM' },
    { day: '06 Aug', status: 'Present', punch: '08:41 AM' },
    { day: '07 Aug', status: 'Present', punch: '08:44 AM' },
    { day: '08 Aug', status: 'Present', punch: '08:46 AM' },
    { day: '09 Aug', status: 'Present', punch: '08:40 AM' },
    { day: '10 Aug', status: 'Sunday', punch: '—' },
    { day: '11 Aug', status: 'Present', punch: '08:45 AM' },
    { day: '12 Aug', status: 'Late', punch: '09:05 AM' },
    { day: '13 Aug', status: 'Present', punch: '08:43 AM' },
    { day: '14 Aug', status: 'Present', punch: '08:47 AM' },
    { day: '15 Aug', status: 'Holiday (Independence Day)', punch: '08:00 AM Event' },
    { day: '16 Aug', status: 'Present', punch: '08:45 AM' },
    { day: '17 Aug', status: 'Sunday', punch: '—' },
    { day: '18 Aug', status: 'Present', punch: '08:42 AM' },
    { day: '19 Aug', status: 'Present', punch: '08:49 AM' },
    { day: '20 Aug', status: 'Absent (Medical Leave)', punch: '—' },
    { day: '21 Aug', status: 'Present', punch: '08:44 AM' },
    { day: '22 Aug', status: 'Present', punch: '08:43 AM' },
    { day: '23 Aug', status: 'Present', punch: '08:46 AM' },
    { day: '24 Aug', status: 'Present', punch: '08:40 AM' },
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="bg-emerald-50 p-4 rounded-2xl border border-emerald-200 shadow-sm">
            ...
            <div className="text-2xl font-black text-emerald-800 mt-1">96.4%</div>
            <p className="text-[10px] text-emerald-600 font-bold mt-1">✓ Board Threshold: 75%</p>
          </div>
          <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
            <span className="text-[10px] font-bold text-slate-400 uppercase">Total Working Days</span>
            <div className="text-2xl font-black text-slate-900 mt-1">112 Days</div>
          </div>
          <div className="bg-blue-50 p-4 rounded-2xl border border-blue-200 shadow-sm">
            ...
            <div className="text-2xl font-black text-blue-800 mt-1">108 Days</div>
          </div>
          <div className="bg-rose-50 p-4 rounded-2xl border border-rose-200 shadow-sm">
            ...
            <div className="text-2xl font-black text-rose-700 mt-1">4 Days</div>
          </div>
        </div>
              ...
              <table className="w-full text-left text-xs">
                <thead className="bg-white border-b border-slate-200 text-slate-500 uppercase font-bold text-[10px]">
                  <tr>
                    ...
                    <th className="p-3 font-mono">Biometric Punch Time</th>
                ...
                <tbody className="divide-y divide-slate-100 font-medium text-slate-700">
                  {augustDays.map((d, idx) => (
                    <tr key={idx} className="hover:bg-slate-50">
                      ...
                      <td className="p-3 font-mono text-[11px] text-slate-600">{d.punch}</td>
