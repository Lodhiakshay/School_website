        ...
        <ClientPortal>
          <div className="fixed inset-0 z-[999999] bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-2 animate-in fade-in duration-150">
            <div className="bg-white rounded-2xl max-w-[275px] w-full p-2 shadow-2xl space-y-1.5 animate-in zoom-in-95 duration-150 border border-slate-200 my-auto">
              ...
              {/* ID Card Wrapper for HD Image Export (Standard PVC Card Dimensions) */}
              <div
                id="faculty-id-card-inner"
                className="printable-document bg-white border-2 border-[#002060] rounded-2xl overflow-hidden shadow-xl text-center font-sans w-full max-w-[255px] mx-auto border-t-4 border-t-[#002060]"
              >
                {/* Lanyard Punch Slot */}
