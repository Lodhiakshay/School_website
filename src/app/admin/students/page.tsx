  ...
  return (
    <PortalLayout allowedRoles={['SuperAdmin', 'Admin', 'Principal', 'AdmissionStaff', 'Accountant', 'Librarian']}>
      ...
      {mounted && showIdCardModal && activeStudent && createPortal(
        <div className="fixed inset-0 z-[99999] bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-2 animate-in fade-in duration-150 overflow-y-auto">
          <div className="bg-white rounded-2xl max-w-[300px] w-full p-2.5 shadow-2xl space-y-1.5 animate-in zoom-in-95 duration-150 border border-slate-200 my-auto">
            ...
            {/* ID Badge Card: Realistic CR80 Vertical PVC Smart Card (Ultra-Compact Mobile Fit) */}
            <div
              id="student-id-card-inner"
              className={`printable-document bg-white border-2 ${
                isSSSD ? 'border-emerald-700' : 'border-[#002060]'
              } rounded-2xl overflow-hidden shadow-xl text-center font-sans w-full max-w-[280px] mx-auto border-t-4 ${
            ...
            >
              ...
              {/* Institution Header Banner (Centered Symmetric Layout) */}
              {isSSSD ? (
                <div className="bg-gradient-to-r from-emerald-950 via-[#064e3b] to-teal-950 text-white p-2 border-b-2 border-amber-400 text-center">
                  ...
                  <p className="text-[7px] uppercase tracking-widest text-emerald-200 font-bold mt-0.5">
                    100% ENGLISH MEDIUM &bull; SHAMSABAD
                  </p>
                  <div className="mt-0.5 bg-emerald-900/90 text-amber-300 text-[7px] font-black uppercase tracking-widest px-2 py-0.2 rounded-full border border-emerald-700 inline-block font-mono shadow-xs">
              ...
              <div className="p-2 space-y-1 bg-gradient-to-b from-white to-slate-50">
                {/* Scholar Portrait (Restored Compact Size) */}
                <div className={`w-13 h-13 rounded-xl border-2 ${isSSSD ? 'border-emerald-600 bg-emerald-50' : 'border-blue-700 bg-blue-50'} mx-auto overflow-hidden p-0.5 shadow-sm ring-1 ring-amber-400`}>
                  <img
                ...
                <div>
                  <h4 className="font-black text-[11px] text-slate-950 font-serif tracking-wide uppercase leading-tight">
                    {activeStudent.firstName} {activeStudent.lastName}
                  </h4>
                  <span className={`inline-block text-[8px] font-black px-2 py-0.2 rounded-full mt-0.5 border shadow-xs ${
                ...
                {/* Demographic Matrix */}
                <div className="bg-white p-1.5 rounded-xl border border-slate-200 text-left text-[9px] space-y-0.5 shadow-xs">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400 font-bold uppercase text-[7.5px]">Scholar / Adm:</span>
                    <span className={`font-mono font-black ${isSSSD ? 'text-emerald-700' : 'text-blue-700'}`}>{activeStudent.admissionNumber}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400 font-bold uppercase text-[7.5px]">Roll Number:</span>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-slate-800 truncate max-w-[125px]">{activeStudent.parentId?.fatherName}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400 font-bold uppercase text-[7.5px]">Emergency Mobile:</span>
                    <span className="font-mono text-slate-900 font-bold">{activeStudent.parentId?.fatherPhone}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400 font-bold uppercase text-[7.5px]">Blood Group &bull; DOB:</span>
                ...
                <div className="bg-slate-100 py-0.5 px-2 rounded-lg border border-slate-200 flex items-center justify-between">
                  ...
                  <span className="text-[7px] font-bold text-slate-500 uppercase font-mono">LIBRARY VERIFIED</span>
                </div>
                ...
                <div className="pt-0.5 pb-0.5 flex items-end justify-between text-[7px] text-slate-400 border-t border-slate-200 px-0.5">
                  <div className="text-left space-y-0.2">
                    ...
                    />
                    <span className={`font-mono text-[6.5px] block font-bold ${isSSSD ? 'text-emerald-800' : 'text-slate-700'}`}>Valid: 2026-2027</span>
                  </div>
                  <div className="text-center">
                    ...
                    />
                    <span className="text-[6.5px] font-bold text-slate-700 block uppercase">Principal Signature</span>
                  </div>
                </div>
              </div>
            </div>
