    ...
    <PortalLayout allowedRoles={['SuperAdmin', 'Admin', 'Principal']}>
      ...
      {activeResult && (
        <div className="fixed inset-0 z-50 bg-slate-950/70 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-2xl w-full p-6 shadow-2xl space-y-4 animate-in zoom-in-95 duration-200 border-2 border-slate-900">
            <div className="flex items-center justify-between border-b border-slate-200 pb-2">
              ...
              <button onClick={() => setActiveResult(null)} className="text-slate-400 hover:text-slate-600 p-1">
                <X className="w-4 h-4" />
              </button>
            </div>

            <div className="p-6 bg-white border-2 border-slate-900 rounded-2xl space-y-4 text-slate-900 text-xs">
              <div className="flex items-center justify-between border-b-2 border-slate-900 pb-3">
                <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-blue-900 bg-white shadow-md flex-shrink-0">
