...
export default function CertificatesAdminPage() {
  ...
  return (
    <PortalLayout allowedRoles={['SuperAdmin', 'Admin', 'Principal']}>
      ...
      {activeCert && (
        <ClientPortal>
          <div className="fixed inset-0 z-[999999] bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-3 sm:p-4 overflow-y-auto w-full h-full min-h-screen">
            <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] flex flex-col p-5 sm:p-6 shadow-2xl border-2 border-slate-900 animate-in zoom-in-95 duration-200 my-auto overflow-hidden">
              ...
              <div className="overflow-y-auto flex-1 py-4 space-y-4">
                <div id="certificate-preview-inner" className="printable-document p-6 sm:p-8 bg-amber-50/40 border-4 border-double border-amber-900/50 rounded-2xl space-y-5 text-slate-900 text-xs shadow-inner font-serif">
                  ...
                  {/* Official Attestation Seals & Signatures */}
                  <div className="pt-6 flex items-end justify-between border-t-2 border-amber-900/30 text-xs gap-4 font-sans">
                    <div className="text-center space-y-1">
                      <img
                        src="/images/stamps/principal-round-seal.png"
                        alt="Institutional Seal"
                        className="w-14 h-14 object-contain mx-auto opacity-90 filter contrast-125"
                      />
                      <span className="font-bold text-slate-700 block text-[11px]">Official School Seal</span>
                      <span className="text-[9px] text-slate-400 block font-mono">Shamsabad, Farrukhabad</span>
                    </div>
                    ...
                    <div className="text-center space-y-1">
                      <img
                        ...
                        className="h-10 max-w-[120px] object-contain mx-auto filter contrast-150"
                      />
                      <span className="font-bold text-slate-900 block text-xs">Dr. Ramesh Kumar Sharma</span>
                      <span className="text-[10px] text-slate-500 block font-serif">Principal &amp; Head of Institution</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap sm:flex-nowrap gap-2 pt-3 border-t border-slate-200 flex-shrink-0">
                ...
                <Button
                  ...
                  onClick={() => {
                    printIsolatedDocument('certificate-preview-inner');
                    toast.success('Sent Attested Certificate to printer.', 'Print Isolated');
                  }}
