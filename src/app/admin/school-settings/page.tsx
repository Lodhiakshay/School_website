        ...
        {activeTab === 'identity' && (
          <div className="space-y-6 animate-in fade-in duration-200">
            ...
            <Card className="border-slate-200 shadow-sm overflow-hidden">
              ...
              <CardContent className="p-3.5 sm:p-6 space-y-5 text-xs">
                ...
                <div className="space-y-1.5 w-full overflow-hidden">
                  ...
                  {cmsData.ticker.isActive ? (
                    <div className="bg-gradient-to-r from-[#000f28] via-[#001c44] to-[#000f28] text-slate-300 py-2.5 px-3 sm:px-4 rounded-xl text-[11px] border border-white/10 shadow-inner w-full overflow-hidden">
                      {/* Desktop Preview */}
                      <div className="hidden sm:flex items-center justify-between gap-3 w-full">
                        <div className="flex items-center gap-3 truncate text-slate-300 min-w-0">
                          {cmsData.ticker.showContactInfo !== false && (
                            <>
                              ...
                              <span className="flex items-center gap-1 text-emerald-400 font-mono flex-shrink-0">
                      ...
                      {/* Mobile Preview (Fully Responsive & Clean) */}
                      <div className="flex sm:hidden flex-col gap-1.5 w-full">
                        <div className="flex items-center justify-between w-full text-[11px] font-bold gap-2">
                          <div className="flex items-center gap-1.5 truncate min-w-0 flex-1">
                            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-ping flex-shrink-0"></span>
                            <span className="inline-flex items-center gap-1 bg-amber-500/20 text-amber-300 px-2 py-0.5 rounded-full border border-amber-500/40 font-black text-[9px] truncate">
                              <Sparkles className="w-2.5 h-2.5 text-amber-400 flex-shrink-0" />
                              <span className="truncate">{cmsData.ticker.badge || 'URGENT ANNOUNCEMENT'}</span>
                            </span>
                          </div>
                          <span className="inline-flex items-center gap-1 text-sky-300 font-black text-[10px] bg-blue-900/60 px-2 py-0.5 rounded-full border border-blue-400/30 flex-shrink-0">
                            <span>Apply</span>
                            <ArrowRight className="w-2.5 h-2.5 text-amber-300" />
                          </span>
                        </div>
                        <div className="text-[10.5px] text-sky-300 font-medium truncate w-full flex items-center gap-1">
                          <span className="truncate flex-1">{cmsData.ticker.text}</span>
                        </div>
                        {cmsData.ticker.showContactInfo !== false && (
                          <div className="flex items-center justify-between text-[9.5px] text-slate-400 border-t border-white/10 pt-1">
                            <span className="truncate flex items-center gap-1">
                              <MapPin className="w-2.5 h-2.5 text-amber-400 flex-shrink-0" />
                              <span className="truncate">{cmsData.address?.city}</span>
                            </span>
