      ...
      <div className="flex items-center gap-1.5 sm:gap-3 flex-shrink-0">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-1.5 text-[11px] sm:text-xs font-bold bg-slate-900 hover:bg-slate-800 text-white px-2.5 sm:px-3.5 py-1.5 sm:py-2 rounded-xl transition shadow-sm whitespace-nowrap"
          >
