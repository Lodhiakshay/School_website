...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <ClientPortal>
      <div className="fixed inset-0 z-[999999] flex items-center justify-center p-3 sm:p-4 bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-150 overflow-y-auto w-full h-full min-h-screen">
        <div
          className={cn(
